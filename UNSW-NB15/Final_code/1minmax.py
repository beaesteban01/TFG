...
min_max_1(df, 'sloss')
min_max_1(df, 'dloss')
min_max_1(df, 'sintpkt')
min_max_1(df, 'dintpkt')
min_max_1(df, 'djit')
min_max_1(df, 'sjit')
min_max_1(df, 'swin')
min_max_1(df, 'stcpb')
...
min_max_1(df, 'smean')
min_max_1(df, 'dmean')
min_max_1(df, 'trans_depth')
min_max_1(df, 'response')
min_max_1(df, 'ct_srv_src')
min_max_1(df, 'ct_state_ttl')
min_max_1(df, 'ct_dst_ltm')
min_max_1(df, 'ct_src_sport_ltm')
min_max_1(df, 'ct_src_dport_ltm')
min_max_1(df, 'ct_dst_ltm')
min_max_1(df, 'is_ftp_login')
min_max_1(df, 'ct_ftp_cmd')
min_max_1(df, 'ct_flw_http_mthd')
min_max_1(df, 'ct_src_ltm')
min_max_1(df, 'ct_srv_dst')
min_max_1(df, 'is_sm_ips_ports')
